...
def load_segmentation_model():
    model_seg = load_model(r"C:\Users\Nishant\Downloads\ResUNet-segModel-weights.hdf5", custom_objects={'focal_tversky': focal_tversky , 'tversky': tversky})
    return model_seg


def load_classfication_model():
    model = load_model(r"C:\Users\Nishant\Downloads\clf-densenet-weights.hdf5")  # Update with your model path
    return model
